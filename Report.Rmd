...
We first examine each variable individually. Below are the sample's summary statistics of each variable.
...
TODO: commentary on meaningfulness... There's nothing unusual... As well, `price`'s standard deviation is \$1,021/month, its minimum is \$150/month, and its maximum is \$9,750/month. We decided that...

\newpage

We also visualize the distribution of each variable individually.
...
TODO: number of observations of each 0/1 in high_price
