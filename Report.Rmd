...
The error appear to have a mean of 0 because the points appear evenly around both sides of e = 0, but the variance is larger at certain areas (like when the fitted values are around 2000 and 3000), so the variance is not perfectly consistent. (Applying transformations to the predictors, such as a squared transformation, were unsuccessful in creating a more favourable distribution.)
